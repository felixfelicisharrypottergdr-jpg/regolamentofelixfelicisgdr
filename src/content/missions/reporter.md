...
levels:
- name: Livello Facile
  action: 'Il PG scrive un articolo positivo su uno dei PNG di Hogwarts. Essi non possono essere mossi dai PG per essere intervistati.
...
- name: Livello Difficile
  action: 'Il PG scrive un articolo su un PG Giocante. Se l''articolo viene pubblicato a seguito di un''intervista ruolata ONGame, il PG Reporter guadagna anche il premio extra.
    ...
    Se il PG reporter denigra all''interno dell''articolo o falsifica negativamente le parole del PG intervistato, trasforma l''azione in Caotica.'
  requirements:
  - //
  rewards:
...
Livello Difficile
Il PG scrive un articolo su un PG Giocante. Se l'articolo viene pubblicato a seguito di un'intervista ruolata ONGame, il PG Reporter guadagna anche il premio extra.
Se il PG reporter denigra all'interno dell'articolo o falsifica negativamente le parole del PG intervistato, trasforma l'azione in Caotica.
