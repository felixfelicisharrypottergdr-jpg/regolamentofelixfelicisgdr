---
id: "492d9123-47fe-5007-87f8-77da3dc6da60"
slug: "homonculous"
name: "Homonculous"
description: "Incantesimo che consente di tracciare in tempo reale i movimenti delle persone e delle Creature presenti all'interno di una zona precedentemente mappata. Quando l'Incantesimo viene attivato sulla Mappa, si manifestano dei piccoli punti e impronte di inchiostro che si spostano dinamicamente sulla pergamena seguendo i movimenti dei soggetti rilevati. Le persone vengono identificate con il proprio nome completo anche quando non sono conosciute dal PG che utilizza Homonculous. Le Creature dotate di un nome proprio vengono identificate attraverso di esso quando possibile, mentre quelle prive di un'identità individuale riconoscibile vengono indicate attraverso la propria specie o tipologia. Nell'istante in cui la magia viene infusa, le linee tracciate sulla pergamena iniziano a vibrare e a scurirsi, assumendo una tonalità nerastra e lucida, come fosse sangue: dai bordi del disegno si diramano minuscoli filamenti di inchiostro simili a capillari, che corrono lungo le linee dei corridoi, delle stanze e degli altri luoghi rappresentati."
wisdom: "Arcaica"
parameter: "Acume"
image: "https://ilovehogwarts.com/wp-content/uploads/2017/03/la-mappa-del-malandrino.jpg"
values:
  - label: "Tipo"
    value: "Arcaico"
  - label: "Parametro"
  ...
  - label: "Forza"
    value: "200"
  - label: "Fatica Creazione Mappa"
    value: "4"
  - label: "Fatica Attivazione"
    value: "Varia"
  - label: "Durata"
    value: "Varia"
searchAliases:
...
**Attivazione**
Una Mappa già preparata viene attivata attraverso Homonculous utilizzando 1 Azione Principale.
Dal momento dell'attivazione, la Mappa mostra in tempo reale i movimenti dei soggetti rilevati per una Durata diversa in base al Livello della Maestria. Si attiva puntando la bacchetta sulla mappa.
*Livello I:* 3 Fatica - fino a 1 Post dell'utilizzatore
*Livello II:* 2 Fatica - fino a 2 Post consecutivi dell'utilizzatore
*Livello III:* 1 Fatica - fino a 3 Post consecutivi dell'utilizzatore
Terminata la Durata, la Mappa smette di aggiornarsi ma rimane utilizzabile fino alla propria scadenza OFFGame. Una nuova consultazione richiede una nuova attivazione di Homonculous e il relativo consumo di Fatica.
...
La Forza Standard di Homonculous è 200, alla quale si aggiunge:
*Livello I:* nessun Bonus
*Livello II:* +50 Forza
*Livello III:* +100 Forza

Livello I: i soggetti occultati magicamente non vengono rilevati dalla Mappa.
Livello II: se la Forza di Homonculous è pari o superiore alla Forza dell'effetto di occultamento, la Mappa rileva la presenza e gli spostamenti del soggetto sotto forma di una macchia o impronta d'inchiostro priva di nome. Se la Forza di Homonculous è inferiore, il soggetto non viene rilevato.
Livello III: se la Forza di Homonculous è pari o superiore alla Forza dell'effetto di occultamento, la Mappa rileva normalmente posizione, spostamenti e identità del soggetto. Se la Forza di Homonculous è inferiore, il soggetto non viene rilevato.

Queste regole si applicano esclusivamente a magie che occultano presenza, posizione o identità. Protezioni che impediscano direttamente la sorveglianza, la Divinazione o la Tracciatura possono avere Specifiche proprie che prevalgono sul normale funzionamento di Homonculous.

**Rilevazione**
Un soggetto tracciato da Homonculous non è automaticamente consapevole di essere osservato.
Se possiede Tracciatura può tuttavia tentare di percepire la sorveglianza magica una sola volta per ciascuna attivazione di Homonculous.
Il tentativo riesce estraendo un risultato compreso tra 1-(Acume + Livello di Tracciante) su:
*Livello I:* 1d30
*Livello II:* 1d40
*Livello III:* 1d50
