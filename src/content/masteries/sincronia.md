---
id: "74b7c967-cb4c-57f3-ac26-a5025c1c7c88"
slug: "sincronia"
name: "Sincronia Sensoriale"
description: "Questa tecnica consente all’evocatore di sincronizzare temporaneamente la propria percezione con quella di un altro individuo, immergendosi nei suoi sensi e percependo il mondo attraverso di lui. Durante l’attivazione, l’evocatore entra in uno stato di trance vigile: il corpo rimane immobile e lo sguardo si fa fisso, poiché la sua attenzione viene proiettata interamente nelle percezioni del Bersaglio. Il Bersaglio conserva pienamente la propria volontà, il controllo del proprio corpo e dei propri sensi. La Sincronia non consente inoltre di accedere ai suoi pensieri, ricordi o emozioni: l'Evocatore può percepire esclusivamente ciò che il Bersaglio sta effettivamente percependo attraverso i sensi coinvolti dalla Maestria."
wisdom: "Mentale"
parameter: "Volontà"
image: "https://64.media.tumblr.com/a2379fd2f2b42882a1c9aeb115c93c79/tumblr_mnsw9k6jxQ1qmrg0eo1_500.gif"
values:
  - label: "Tipo"
    value: "Mentale"
  - label: "Parametro"
...
Per tutta la durata della Sincronia l'Evocatore deve mantenere la concentrazione sul collegamento sensoriale.
Il suo corpo rimane immobile e non può compiere altre Azioni Principali finché mantiene attiva la Maestria.
...
È sempre il Narratore a mediare le informazioni percepite dall'Evocatore, comunicando via MP oppure attraverso il proprio successivo post ciò che egli riesce effettivamente a vedere, sentire o percepire in base al Livello della Maestria.

Accorgersi del tentativo in corso
Quando l'Evocatore attiva la Sincronia in presenza del Bersaglio, l'attacco non produce effetti immediatamente evidenti e il Bersaglio non può difendersi automaticamente soltanto perché il Player conosce OFFGame l'intenzione dell'Evocatore.
...
Possono effettuare il dado di Tracciatura anche eventuali PG presenti in grado di percepire il tentativo di attacco magico.
Quando la Sincronia viene invece attivata a distanza, non è possibile percepire preventivamente il tentativo attraverso Tracciatura, poiché l'Evocatore non si trova nella scena del Bersaglio.
...
Poiché la Sincronia utilizzata a distanza dura sempre e soltanto 1 post, il Bersaglio può accorgersi dell'invasione ma non può interrompere retroattivamente ciò che l'Evocatore ha già percepito durante quel post.

Rilevare la connessione in corso
