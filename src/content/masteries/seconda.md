---
id: "8c93aa78-54ef-5a8c-8d10-d85504314cf3"
slug: "seconda"
name: "Seconda Fioritura"
description: "Abilità che consente all'Erbologo di opporsi al naturale spegnersi della vita vegetale, richiamando nelle Piante Magiche un ultimo e potentissimo riflusso di energia linfatica: attraverso un profondo contatto empatico con la loro essenza, il PG può sottrarre una Pianta alla morte imminente, salvarla quando viene incontrata ormai Morente e persino permettere alle proprie Piante di percorrere nuovamente l'ultimo tratto del loro ciclo vitale, concedendo loro una vera e propria Seconda Fioritura. Questa rinascita non è però infinita: si tratta di un dono eccezionale, un'ultima occasione concessa alla Pianta prima del definitivo esaurimento biologico. Proprio per questo, il suo ultimissimo raccolto risulta straordinariamente abbondante, come se tutta l'energia residua si concentrasse in un ultimo slancio vitale."
wisdom: "Erbologica"
parameter: "Empatia"
image: "https://i.postimg.cc/K8sbyJX3/image.png"
values:
  - label: "Tipo"
    value: "Erbologica"
  - label: "Parametro"
...
**• Livello I**
La Pianta Morente viene stabilizzata e riportata a uno stato non più Morente se, lanciando *1d40*, il PG ottiene un risultato compreso fra 1 e il proprio valore di Empatia. Al tiro non si applica alcun Bonus.
Questo tentativo può essere effettuato una sola volta per ogni Ricerca Casuale.
Fallire il dado consuma comunque l'unico utilizzo disponibile.
*Fatica Consumata:* 3 Fatica

**• Livello II**
La Pianta Morente viene stabilizzata e riportata a uno stato non più Morente se, lanciando *1d30*, il PG ottiene un risultato compreso fra 1 e il proprio valore di Empatia. Al tiro non si applica alcun Bonus.
Questo tentativo può essere effettuato fino a due volte per ogni Ricerca Casuale.
