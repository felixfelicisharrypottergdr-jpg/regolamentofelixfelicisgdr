---
id: "d4c3a7ed-9e9f-5a89-b68c-f5fcb30f6506"
slug: "metamagia"
name: "Metamagia"
description: "Abilità con cui il mago o la strega impara a trattenere dentro di sé una parte dell'energia residua prodotta dagli Incantesimi che evoca. Lancio dopo lancio, questa energia si accumula come una pressione magica latente, impercettibile agli altri ma sempre più evidente per chi la custodisce. Una volta raccolta una quantità sufficiente di energia, può liberarla durante una nuova evocazione e interferire direttamente con la struttura dell'Incantesimo, estendendone la Durata o la Gittata, ampliando l'Area interessata, aumentandone la potenza, riducendo lo sforzo fisico necessario o alterando il modo in cui viene utilizzato. La Metamagia non costituisce un nuovo Incantesimo, ma una manipolazione della magia che il mago o la strega sta già evocando."
wisdom: "Arcaica"
parameter: "Acume"
image: "https://i.postimg.cc/t43BMWW0/image.png"
values:
  - label: "Tipo"
    value: "Arcaico"
  - label: "Parametro"
...
Non può essere applicata agli *Incantesimi Oscuri* né agli *Incantesimi Autoconclusivi*.

**Accumulare Energia Metamagica**
Ogni volta che il PG evoca personalmente un Incantesimo compatibile con la Metamagia durante una Role accumula una certa quantità di *Punti Metamagia* in base alla tipologia dell'Incantesimo e alla percentuale con cui lo conosce.
I Punti vengono generati nel momento in cui l'Incantesimo viene correttamente evocato: eventuali successive Reazioni, Resistenze, immunità, confronti di Forza o altri effetti che impediscano alla magia di avere conseguenze sul bersaglio non annullano l'energia prodotta.
Non vengono invece generati Punti se l'evocazione stessa fallisce o non arriva a produrre l'Incantesimo.
Non generano Punti Metamagia Pozioni, Piante, Creature, Oggetti Magici, effetti già immagazzinati, magie che si attivano autonomamente, Incantesimi Oscuri e Incantesimi Autoconclusivi.
...
*Livello II:* 5 Punti Metamagia
*Livello III:* 6 Punti Metamagia
Gli eventuali Punti ottenuti oltre questo limite vengono perduti.
I Punti Metamagia accumulati valgono esclusivamente per la Role in corso e si azzerano al termine della stessa.

**Utilizzare la Metamagia**
Quando possiede abbastanza Punti, il PG può spenderli durante l'evocazione di un Incantesimo compatibile per modificarne alcune caratteristiche.
L'utilizzo della Metamagia vale come *Azione Bonus* e deve essere dichiarato contestualmente all'Incantesimo che si desidera modificare. Qualunque modifica scelta, compresa *Doppia Metamagia*, richiede una sola Azione Bonus.
I Punti vengono consumati nell'istante in cui la modifica viene utilizzata e non vengono recuperati qualora l'Incantesimo venga successivamente schivato, contrastato, resistito o neutralizzato.
L'Incantesimo modificato tramite Metamagia non genera Punti Metamagia, anche se normalmente ne produrrebbe.
Le modifiche possono intervenire soltanto su caratteristiche già possedute dall'Incantesimo e compatibili con il suo funzionamento: non possono attribuirgli proprietà che normalmente non possiede. Per esempio, un Incantesimo dalla Durata *istantanea* non può usufruire di *Durata Estesa*.
Le modifiche disponibili dipendono dal Livello della Maestria:
*Livello I:* può utilizzare le modifiche dal costo di 2 o 3 Punti.
