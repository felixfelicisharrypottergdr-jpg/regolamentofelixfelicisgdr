---
id: "f1ba2116-a393-513a-b66f-a5ef6b9ab839"
slug: "glifo"
name: "Glifo Involutio"
description: "Incantesimo che consente di tracciare un Glifo dalle forme geometriche e aritmantiche all'interno del quale viene immagazzinato un Incantesimo conosciuto dall'Evocatore. Il potere rimane latente fino al verificarsi delle condizioni di innesco consentite dal Livello della Maestria, momento in cui il Glifo libera autonomamente la magia contenuta. Il Glifo può essere tracciato su superfici solide come pavimenti, pareti, porte, tavoli o Oggetti e può reagire al contatto, alla lettura, alla prossimità o, ai Livelli più avanzati, a condizioni specificamente programmate dall'Evocatore."
wisdom: "Arcaica"
parameter: "Acume"
image: "https://i.postimg.cc/2jHC1Ch6/image.png"
values:
  - label: "Tipo"
    value: "Arcaico"
  - label: "Parametro"
  ...
  - label: "Gittata"
    value: "Contatto"
  - label: "Fatica"
    value: "Varia + Fatica Incantesimo"
  - label: "Durata"
    value: "Varia"
searchAliases:
  - "glifo"
...
Il Glifo deve essere tracciato su una superficie materiale stabile raggiungibile direttamente dalla Bacchetta dell'Evocatore.
Parametri, Forza ed eventuali Bonus o Malus dell'Incantesimo vengono calcolati al momento della creazione e rimangono quelli del Glifo fino alla sua attivazione.
L'eventuale Durata dell'Incantesimo immagazzinato comincia soltanto nel momento in cui il Glifo viene attivato.

**Fatica Consumata**
La creazione consuma un valore Base di Fatica diverso in base al Livello della Maestria + la normale Fatica dell'Incantesimo immagazzinato.
*Livello I:* 3 Fatica Base
*Livello II:* 2 Fatica Base
*Livello III:* 1 Fatica Base
Eventuali modificatori alla Fatica derivanti dalla modalità con cui viene evocato l'Incantesimo immagazzinato si applicano normalmente.
Quando il Glifo viene successivamente attivato non viene consumata ulteriore Fatica.

**Incantesimi immagazzinabili**
Il Livello della Maestria determina sia il numero di Glifi che il PG può mantenere contemporaneamente attivi sia la tipologia di Incantesimi che può immagazzinare al loro interno.

Livello I: può mantenere attivo 1 Glifo, nel quale può essere immagazzinato esclusivamente un Incantesimo Scolastico o Extra.

Livello II: può mantenere attivi fino a 2 Glifi contemporaneamente. Possono contenere Incantesimi Scolastici o Extra e uno soltanto dei Glifi attivi può contenere un Incantesimo Avanzato.

Livello III: può mantenere attivi fino a 3 Glifi contemporaneamente, senza limitazioni nella distribuzione fra Incantesimi Scolastici, Extra o Avanzati conosciuti dal PG.

Se viene creato un nuovo Glifo oltre il limite consentito, il PG deve indicare quale dei propri Glifi precedenti perde efficacia. In assenza di indicazioni si dissolve automaticamente quello creato da più tempo.
La dissoluzione provocata dal superamento del limite non attiva né libera l'Incantesimo immagazzinato.
Al di fuori di questo caso, un Glifo già creato può essere eliminato facendolo scattare oppure attraverso Spezzamento.
...
- caratteristiche biologiche oggettive e direttamente riconoscibili;
- appartenenza a gruppi, organizzazioni o istituzioni oggettivamente definiti e la cui appartenenza sia pubblicamente nota e riconoscibile ONGame.
L'Evocatore può stabilire sia quali soggetti debbano provocare l'attivazione sia quali debbano essere ignorati dal Glifo.

Il Glifo non può utilizzare caratteristiche biologiche nascoste, discendenze, legami di sangue o altre informazioni che non siano direttamente riconoscibili.
...
**Rilevazione**
Il Glifo può essere individuato sia durante la sua creazione sia successivamente.

Durante la creazione: un PG presente può accorgersi dell'evocazione se, lanciando 1d40, ottiene un risultato compreso tra 1-(Acume + Livello di Tracciante).
Nel caso in cui il Glifo venga creato in segreto, sarà il Narratore a effettuare gli eventuali lanci per i PG coinvolti.

Dopo la creazione: è possibile riconoscere la presenza e la natura magica del Glifo mediante Tracciatura, applicando al normale tentativo il seguente Malus:
*Livello I:* -5 possibilità
*Livello II:* -10 possibilità
*Livello III:* -15 possibilità

La semplice visibilità del Glifo di Livello I o l'eventuale percezione della distorsione provocata da quello di Livello II non permette di conoscerne automaticamente natura, Incantesimo immagazzinato o condizioni di attivazione.

Nel caso in cui il Glifo sia stato creato in segreto, sarà il Narratore a gestire la Rilevazione secondo le normali regole di Tracciatura.
