...
migration:
  ...
  sources:
    - document: "1. Le Regole del Gioco"
      section: "Gli Allineamenti"
---

# Gli Allineamenti

L'allineamento è la caratteristica utilizzata dalla maggior parte dei giochi di ruolo per riassumere, attraverso canoni ben delineati, l'atteggiamento morale, etico e psicologico dei personaggi giocanti e non giocanti. Semplificando al massimo, si può dire che grazie all'allineamento è possibile definire se un personaggio è tendenzialmente buono, malvagio o neutrale nei confronti della vita e di tutte le situazioni che gli si possono presentare.
In Felix Felicis GdR, i PG Studenti ed i PG Adulti hanno la possibilità di scegliere tra diversi Allineamenti, che consentono di definire il loro carattere secondo alcuni principi e dogmi ben precisi.

<a id="allineamadulti"></a>
## Gli Allineamenti dei PG Adulti
L'Allineamento scelto dai PG Adulti influenza il tipo di gioco che è possibile creare, per esempio nella possibilità di giocare certi spunti di gioco al posto di altri, grazie all'acquisizione di speciali punti, chiamati Punti Virtuosi e Punti Sinistri. Questi ultimi sono strettamente collegati all'Allinamento del PG: infatti, un PG con un certo Allineamento ha delle limitazioni precise rispetto ai punti che può guadagnare o meno nel corso del gioco.
Gli Allineamenti per PG Adulti disponibili sul nostro gioco sono 9.
Da Wikipedia.
...
<a id="allineamstudenti"></a>
## Gli Allineamenti dei PG Studenti
Anche nel momento della creazione di un PG Studente è necessario scegliere uno degli Allineamenti disponibili per loro.
Come per i PG Adulti, essi rappresentano tre modi diversi di approcciarsi al gioco e di ottenere informazioni, conoscenze, di svolgere determinate cose all'interno del castello di Hogwarts o di avere libero accesso ad altre (vedere Punti Bontà e Punti Malvagità).
Gli Allineamenti per PG Studenti disponibili sul nostro gioco sono 3.
...
*Esempio di Legale volto al bene: un PG intransigente con le regole scolastiche, che non entrerebbe mai all'interno del Reparto Proibito, a meno che non ci siano motivi più grandi per cui è costretto a farlo.
Esempio di Legale volto al male: un PG che sfida clandestinamente un altro PG ad un duello ma vuole prima assicurarsi che abbia la bacchetta e tutto ciò che gli serve per combattere ad armi pari.
...
> **Nota.**
>
Se hai dei dubbi su quale Allineamento sia più adatto al tuo PG, puoi svolgere questo test rispondendo alle domande come risponderebbe lui/lei!
