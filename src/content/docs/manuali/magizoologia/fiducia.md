---
title: Fiducia
description: Procedura con cui il PG tenta di infondere Fiducia in una Creatura Magica.
felixId: "11111111-1111-4111-8111-111111111111"
contentType: rule
searchAliases:
  - fare amicizia con una creatura
  - farsi accettare da una creatura
  - avvicinarsi a una creatura
  - interagire con una creatura
...
• **Uovo **• la Fiducia è **autoconclusiva **(non è necessario lanciare alcun
dado);
• **Creatura Infante** • se il risultato del dado è negativo, lanciare **1d4**: se
1-2-3 la Creatura resta ed ignora i PG, se 4 si allontana;
• **Creatura Adolescente** • se il risultato del dado è negativo, lanciare **1d4**:
se 1-2 la Creatura resta ed ignora i PG, se 3 la Creatura si allontana, se 4 diventa ostile;
• **Creatura Adulta** • se il risultato del dado è negativo, lanciare **1d4**: se 1-2
la Creatura si allontana, se 3-4 diventa ostile;
• **Creatura Anziana** • se il risultato del dado è negativo, lanciare **1d4**: se
