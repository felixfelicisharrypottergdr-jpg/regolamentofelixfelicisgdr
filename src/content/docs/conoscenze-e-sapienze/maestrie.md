---
title: Maestrie
description: "Forme di magia estremamente avanzata accessibili a chi possiede un'impareggiabile padronanza della relativa Sapienza Magica."
felixId: "3f92e8f9-45ff-4639-b582-200e69204918"
contentType: landing
searchAliases:
  - maestrie
  - specializzazioni
  - specializzazione sapienza
  - livello III maestria
applicability:
  - adult
quickFacts:
  - label: "Maestrie disponibili"
    value: "36"
  - label: "Per Sapienza Magica"
    value: "3"
  - label: "Requisito Sapienza"
    value: "25/25"
  - label: "Requisito Parametro"
    value: "18"
  - label: "Livelli"
    value: "I · II · III"
quickLinks:
  - label: "Catalogo delle 36 Maestrie"
    href: "/conoscenze-e-sapienze/maestrie/catalogo/"
...
- 1 Livello II e 1 Livello I (II-I)

- 1 Livello II e 2 Livelli I (II-I-I)

- 2 Livelli II (II-II)

- 2 Livelli II e 1 Livello I (II-II-I)

- 1 Livello III (III)

- 1 Livello III e 1 Livello I (III-I)

- 1 Livello III e 2 Livelli I (III-I-I)

- 1 Livello III e 1 Livello II (III-II)
...
**Esempio.**
Mary Sue ha tutte e tre le Maestrie relative alla Sapienza Divinatoria, sviluppate al massimo possibile. Per via delle limitazioni, ha necessariamente: una al Livello III, una al Livello II, una al Livello I.
Mary Sue può sviluppare Maestrie anche nella Sapienza Arcaica (avendone i requisiti). Anche per queste, può averne al massimo una al Livello III, una al Livello II e una al Livello I.

Poiché un PG può possedere al massimo 4 Sapienze Magiche, può sviluppare al massimo 12 Maestrie (e di queste, al massimo 4 al Livello III, ciascuna relativa a Sapienze diverse), a patto di rispettare i requisiti necessari.
Raggiungere un numero elevato di Maestrie rappresenta tuttavia un investimento estremamente impegnativo. Ogni nuovo acquisto e ogni potenziamento richiedono infatti grandi quantità di Galeoni e Punti Post e, soprattutto, ciascuna Maestria necessita di 18 nel proprio Parametro di riferimento. Un PG che desideri specializzarsi in numerosi campi dovrà quindi sviluppare in maniera considerevole anche Parametri differenti.

**Perché?**
**... perché non posso portare tutte e tre le Maestrie della stessa Sapienza al Livello III?**
Le Maestrie rappresentano capacità eccezionali persino per chi ha raggiunto la massima padronanza di una Sapienza Magica.
Il loro scopo è differenziare il più possibile i PG e permettere che anche personaggi ugualmente competenti nella stessa branca sviluppino specializzazioni differenti senza avere cosi PG tuttologi.
...
Una singola Maestria può comunque prevedere nelle proprie Specifiche dadi o altre meccaniche necessarie a risolverne determinati effetti: questi non rappresentano il dado di riuscita della Maestria, ma si applicano esclusivamente nei casi espressamente indicati.
L'attivazione della Maestria è quindi autoconclusiva per quanto riguarda le capacità del PG: chi possiede una Maestria al Livello II, per esempio, può utilizzarne direttamente gli effetti indicati per il Livello II senza dover stabilire attraverso il normale dado di riuscita quanto efficacemente riesce a padroneggiarla.
Questo non rende tuttavia autoconclusive le conseguenze narrative del suo utilizzo.
...
Maestrie Erbologiche

 Genesi Primordiale
 Richiamo della Linfa
 Seconda Fioritura

Maestrie Magizoologiche

 Alleato dei Centauri
 Guardiano dei Draghi
 Voce dei Maridi

Maestrie Medimagiche
...
Maestrie Oscure
 ...
 Maestro delle Fatture
 Padre dell'Increato
 Signore degli Inferi

Maestrie Pozionistiche

 Creazione di Homuncoli
 Mimesi Chimerica
 Transmutazione Alchemica

Maestrie Trasfigurative
