---
felixId: "475ebcd1-5f8f-4dd5-8499-376735b7c471"
title: "Ricerca Casuale di Crimini"
description: "Procedura completa dei Crimini autogestiti."
contentType: rule
searchAliases:
  - "ricerca crimini"
  - "crimini"
...
migration:
  ...
  sources:
    - document: "9. Ricerche Casuali"
      section: "Ricerca Casuale di Crimini"
---

# Ricerca Crimini

Nel Mondo Magico Oscuro, minacce come Streghe e Maghi Oscuri, contrabbandieri, artefatti
proibiti o rituali malefici sono frequenti. I PG Intracciabili e i PG Oscuri si muovono
nell’ombra per investigare, infiltrarsi o portare a termine incarichi criminali senza essere
individuati.
...
L’esecuzione dei Crimini può avvenire in Gran Bretagna o all’estero.
Se il Crimine è commissionato all’estero, il **mandante PNG/PPNG** copre il viaggio
**solo** per l’esecuzione dell’incarico.
...
> **Nota.**
>
Giocando la Ricerca Crimini non è possibile riscattare i premi delle
Missioni Caotiche del FantaWiz.
...
scoprire, individuare l’oggetto da sottrarre e riuscire a fuggire con il bottino.
...
>
**Il Bottino**
Il valore e l’importanza del bottino determinano il livello di rischio e la difficoltà dell’azione,
nonché il grado di complessità della missione e l’attenzione che le forze dell’ordine
potrebbero dedicare al furto.
Per stabilire la classe di difficoltà del furto, si lancia 1d3 all’inizio della missione.
**1:** Bottino Minore
Sorveglianza minima, rischio contenuto. +3 alle Possibilità di tutti i tiri.
(Esempi: piccoli furti, refurtiva marginale, materiale di basso valore)
**2:** Bottino Notevole
Sorveglianza media, rischio moderato. Nessun bonus o Malus.
(Esempi: bottino di valore, refurtiva custodita o sorvegliata, denaro o risorse pregiate)
**3:** Bottino Elevato
Sorveglianza alta, rischio significativo. Malus di -4 a tutti i tiri di missione.
(Esempi: refurtiva molto preziosa, materiali rari, beni o informazioni fortemente protetti)

La missione si articola in tre fasi:
**Fase I - Infiltrazione**
**Descrizione:** i PG si avvicinano al luogo del furto e tentano di entrare inosservati,
evitando barriere magiche, allarmi o guardie.
**Riesce se:** lanciando 1d40, il risultato è compreso fra 1 e il totale di
...
**Fase III - Fuga**
**Descrizione:** i PG tentano di lasciare il luogo del furto senza essere individuati,
sfruttando la confusione, incantesimi o passaggi segreti.
**Riesce se:** lanciando 1d50, il risultato è compreso fra 1 e il totale di
...
il bottino (missione fallita).

> **Esempio.**
>
**Crimine:** I PG stanno tentando di mettere a segno un **furto** presso un
...
Le guardie trovano solo la cassa vuota e tracce di magia oscura.
...
come indicato nella Fase II.

>
**1. Comune e Discreto**
**Descrizione:** merce neutra, facilmente occultabile o non sospetta (es. ingredienti
comuni, erbe, componenti base)
**Modificatore:** +3 a tutte le fasi
**2. Sensibile ma Gestibile**
**Descrizione:** materiali con leggere emanazioni magiche o valore moderato;
richiedono attenzioni ma non attirano facilmente sospetti
**Modificatore:** nessun bonus né malus
**3. Illegale o Instabile**
**Descrizione:** merce pericolosa, volatile, rumorosa o con emissioni magiche evidenti;
difficile da nascondere
**Modificatore:** -3 Malus a tutte le fasi
**4. Altamente Proibito e Compromettente**
**Descrizione:** carico che attira attenzione (luci, odori, suoni, emanazioni magiche
forti); altissimo rischio di scoperta
**Modificatore:** -5 Malus a tutte le fasi

La missione si articola in tre fasi:
**Fase I - Preparazione e Carico**
**Descrizione:** i PG si procurano o ricevono la merce e preparano il viaggio,
occultando il carico e scegliendo il percorso più sicuro. Devono evitare sospetti, controlli o
...
**Fase II - Trasporto e Attraversamento**
**Descrizione:** i PG si mettono in viaggio e devono trasportare il carico evitando
imprevisti.
I PG devono determinare il tipo di carico e scegliere il mezzo di trasporto. Alcuni carichi non
sono compatibili con tutti i mezzi: forzare la combinazione può comportare malus o rischi
aggiuntivi.
**Trasporti e compatibilità**

>
**Attenzione:** in questo caso non si applicano i bonus, malus e i parametri soliti dei
Mezzi di Trasporto. I mezzi sono considerati disponibili di base ai
fini della Ricerca.
Si segua soltanto quanto indicato in questa guida. I malus accumulati durano fino alla fine
della role.
Quando una combinazione non compatibile richiede una verifica di integrità, si effettua un
unico lancio di 1d5 per tutto il gruppo.
**Carrozza Magica/a piedi/su creatura**
...
**Descrizione:** i PG devono completare la consegna e cancellare le proprie tracce,
confondendo eventuali inseguitori o testimoni.
**Riesce se:** lanciando 1d50, il risultato è compreso fra 1 e il totale di
...
1d50 → 20 → riesce
PG2: 12 Destrezza + 11 Fatica - 3 Carico + 2 Sapienza = 22 possibilità su 50
1d50 → 36 → fallisce
**PG1** riesce a guidare PG2 verso la destinazione, usando *Muffliato* e
incantesimi di occultamento. Il carico arriva integro nelle mani del committente.
**Missione completata con successo.**
Ricompense: 1 Punto Sinistro, 2 Galeoni per post (max 5 post), 2 PP per post (max 5 post).
...
corruzione, intimidazione o ricatto, senza fare uso di magia direttamente sul bersaglio né
...
*Successo (se almeno un PG riesce):* i PG ottengono informazioni sufficienti per
passare alla Fase II.
*Fallimento (se tutti i PG falliscono):* Ogni PG che fallisce il proprio tiro subisce
personalmente un malus di -3 alle Possibilità della Fase II. Se tutti i PG falliscono, il malus di
-3 si applica quindi a tutti.
Il PG lancia 1d6 per stabilire il Profilo della Vittima:

>
1. Avido: motivato dal guadagno, cerca vantaggi economici
2. Codardo: paura, tende a cedere sotto pressione ma fugge se messo alle strette
3. Sospettoso: diffida di tutti, non si fida facilmente
4. Orgoglioso: non si piega, pone valore sull’onore e l’immagine
5. Pericoloso: ha potere, alleati o armi; rischioso da provocare
6. Ingenuo: crede alle promesse, facilmente corrompibile e manipolabile

**Fase II - Pianificazione e Avvicinamento**
**Descrizione:** i PG devono organizzare l’incontro con la vittima, scegliere il momento,
il luogo e il modo di presentarsi. La riuscita determina quanto il PNG è predisposto ad
ascoltare nella fase finale, ma non garantisce che ceda subito.
**Riesce se:** ciascun PG lancia 1d40; il risultato deve essere compreso fra 1 e il totale
della propria Volontà+Acume, applicando l'eventuale malus personale di -3 ottenuto nella
Fase I.
**Successo (se almeno un PG riesce)**: i PG riescono nell'organizzazione senza
particolari intoppi. Tutti i PG ottengono +3 alle Possibilità della Fase III.
**Fallimento (se tutti i PG falliscono):** si presenta un intoppo durante l'avvicinamento.
Tutti i PG subiscono -3 alle Possibilità della Fase III.
**Fase III - Applicazione della Modalità**
**Descrizione:** dopo aver individuato il PNG da avvicinare nella Fase I, i PG devono
...
**Successo (almeno un PG riesce):** la vittima mantiene l’accordo, i PG ottengono ciò
che vogliono. Missione completata con successo.
**Fallimento (tutti i PG falliscono):** la vittima non accetta o si ribella; la missione
fallisce.
...
→ 10/5 dà 2
→ 3/2 dà 1
→ 11+2+2+3+1 = **19 possibilità su 60**
Lancia 1d60 → esce 35 → **fallisce**
...
Le azioni da sicario non possono essere eseguite presso abitazioni o luoghi appartenenti a
...
**Descrizione:** i PG raccolgono informazioni sulla vittima, valutano debolezze, rapporti
sociali, interessi e possibili punti di pressione.
Per stabilire il profilo del bersaglio, lanciare 1d4.

>
**1: Isolato/Poco noto**
*Descrizione:* il bersaglio vive o opera in luoghi poco frequentati; scarsa sorveglianza,
poche visite, poche relazioni pubbliche.
*Effetto:* +3 Possibilità in tutte le fasi
**2: Conosciuto in un certo contesto/Moderatamente interessante**
*Descrizione:* il bersaglio è noto in un raggio locale (bottega rinomata, figura pubblica
di quartiere). Sorveglianza occasionale, visita di conoscenti, discreta attenzione.
*Effetto:* nessun malus né bonus
**3: Ricco/Frequentato/Ben collegato**
*Descrizione:* il bersaglio è benestante, ha frequentatori o protegge beni di valore;
guardie private o servitori non sono rari.
*Effetto:* -3 Possibilità in tutte le fasi
**4: Celebre/Altamente sorvegliato/Protetto magicamente**
*Descrizione:* il bersaglio è molto esposto (collezionista famoso, ufficiale locale,
laboratorio protetto); sorveglianza continua, difese magiche.
*Effetto:* -5 Possibilità in tutte le fasi

Per stabilire il tipo di incarico, lanciare 1d5:
>
**1: Eliminazione totale**
*Descrizione:* il mandante richiede la morte del bersaglio.
**2: Punizione o vendetta**
*Descrizione:* il bersaglio va ferito, menomato o pubblicamente umiliato.
**3: Rimozione di ricordi/Manipolazione mnemonica**
*Descrizione:* cancellare o alterare memorie specifiche del bersaglio.
**4: Inscenamento**
*Descrizione:* simulare incidente, suicidio, scomparsa o danneggiare la reputazione.
**5: Missione alternativa o simbolica**
*Descrizione:* eliminare un oggetto, ricordo o legame (di valore simbolico).

**Esecuzione (modalità a scelta):**
→ *Raccolta di informazioni dai testimoni:* il PG lancia 1d40 ed estrae un numero
compreso fra 1 e il totale della sua Volontà+Dialettica+Lv Persuasore+Sapienza Mentale/5
più o meno Bonus o Malus Profilo. In questa modalità non è possibile ottenere bonus tramite
Pozioni o magie: se vengono utilizzate in presenza dei testimoni, questi scappano
autoconclusivamente e il tentativo tramite testimoni fallisce.
→ *Pedinamento e spionaggio:* il PG lancia 1d30 ed estrae un numero compreso fra 1
e la sua Destrezza-Popolarità/2 più o meno Bonus o Malus Profilo.
→ *Individuazione tracce di magia:* il PG lancia 1d40 ed estrae un numero compreso
fra 1 e il totale del suo Acume+Sapienza Arcaica/5 più o meno Bonus o Malus Profilo.
→ *Altro che abbia a che vedere con intimidazioni, minacce, ricatti:* il PG lancia 1d60
ed estrae un numero compreso fra 1 e il totale di Volontà+Sapienza Oscura o Mentale/5+Lv
Persuasore+Dialettica+Punti Sinistri/2 più o meno Bonus o Malus Profilo. Il PG sceglie se
...
*Fallimento (se tutti i PG falliscono):* la vittima sospetta di qualcosa; si passa
comunque alla Fase II, ma tutti i PG subiscono un malus di -3 Possibilità.
**Fase II - Avvicinamento**
**Descrizione:** i PG trasformano le informazioni raccolte in un piano solido. Si
occupano di decidere tempistica, ruoli, risorse, coperture, vie di fuga, contingenze e prova
generale. La sua riuscita determina quanto il piano sarà efficiente, rapido e “pulito” quando si
passerà alla Fase III.**Esecuzione:** il PG riesce se, lanciando 1d35, estrae un numero compreso fra 1 e
...
*Fallimento (se tutti i PG falliscono):* il piano manca di qualcosa; si passa comunque
alla Fase III con un Malus di -3 Possibilità per tutti i PG.
**Fase III - Esecuzione**
**Descrizione:** i PG mettono in atto il piano elaborato nella Fase II, sfruttando al
massimo le risorse, i vantaggi ambientali e le coperture predisposte. L’obiettivo è eseguire
l’incarico con precisione, evitando testimoni, errori o tracce che possano ricondurre al
mandante o al gruppo.
La riuscita determina se l’azione ha effetto pieno, parziale o se fallisce, e quanto sarà facile
coprire le proprie tracce.
**Esecuzione (metodo a scelta):** Il PG riesce se, lanciando 1d40, estrae un numero
compreso fra 1 e il totale dei valori elencati più o meno Bonus o Malus Fase II e Profilo del
bersaglio.
...
**Fallimento (se tutti i PG falliscono):** il bersaglio sopravvive o l’effetto non è duraturo.
I PG devono fuggire.
...
**Risultato:** almeno un PG riesce, quindi i personaggi ottengono informazioni
...
illegali.
I PG si occupano di costruire una rete di contatti, reperire fondi, gestire la logistica e
controllare lo svolgimento dell’evento mantenendo segretezza e ordine evitando sospetti o
interventi esterni.
...
Per stabilire la tipologia di evento, lanciare 1d5:

>
**1:** Duello/scontro/torneo/gare non autorizzati
**2:** Festa o spettacolo illegale
**3:** Asta di oggetti oscuri/illegali
**4:** Raduno magico
**5:** Evento di copertura

**Esecuzione (modalità a scelta):** riesce se, lanciando 1d50, il PG estrae un numero
compreso fra 1 e la soglia del metodo scelto:→ *Persuasione:* Volontà+Dialettica+Lv Persuasore+Sapienza Mentale/5
...
*Fallimento (tutti i PG falliscono):* sorgono sospetti o mancano risorse; si passa
comunque alla Fase II con un Malus di -3 Possibilità per tutti i PG.
**Fase II - Organizzazione e Sicurezza**
**Descrizione:** i PG si dedicano all’allestimento dell’evento: pianificano la logistica,
gestiscono la sicurezza, stabiliscono turni, vie di fuga, codici e protezioni magiche.
Una buona organizzazione rende l’evento stabile e sicuro; un errore può comprometterlo
...
*Fallimento (tutti i PG falliscono):* sorgono problemi logistici o la sicurezza è debole; si
passa comunque alla Fase III con un Malus di -3 Possibilità per tutti i PG.
**Fase III - Svolgimento dell’Evento**
**Descrizione:** l’evento si tiene. I PG devono garantire che tutto proceda senza
incidenti, mantenendo il controllo di partecipanti, guardie e spettatori.
La riuscita determina se l’evento si conclude con profitto e discrezione o se degenererà in
caos, perdite o scoperta.
**Esecuzione:** il PG riesce se, lanciando 1d60, il risultato è compreso fra 1 e
Volontà+Sapienza Mentale o Oscura/5+Dialettica+Punti Sinistri/2 più o meno Bonus o Malus
...
> **Esempio.**
>
**Crimine:** I PG ricevono l’incarico di organizzare una **festa/spettacolo illegale**
...
Lancio 1d50 → esce 18 → **successo**
PG2: Volontà 11, Punti Sinistri 4, Sapienza Oscura 12
→ 4/2 dà 2
→ 12/5 dà 2
...
Lancio 1d35 → esce 16 → **successo**
PG2: Acume 10, Sapienza Arcaica 9
→ 9/5 dà 1
...
60**
Lancio 1d60 → esce 20 → **successo**
PG2: Volontà 11, Sapienza Mentale 9, Dialettica 3, Punti Sinistri 4
→ 9/5 dà 1
→ 4/2 dà 2
