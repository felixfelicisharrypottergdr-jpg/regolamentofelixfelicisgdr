---
felixId: "f84d8577-a9f7-43b6-9348-dc9b5b993e48"
title: "Categorie Magiche"
description: "Acumen, Animus, Ars, Numen, Sensus, Voluntas e PG Intracciabili."
contentType: rule
searchAliases: [categorie magiche, wombat, acumen, animus, ars, numen, sensus, voluntas, intracciabili]
applicability: [adult]
quickFacts:
  - label: "Categorie"
    value: "Acumen · Animus · Ars · Numen · Sensus · Voluntas"
  - label: "Test"
    value: "W.O.M.B.A.T."
  - label: "Rifiuto del Test"
    value: "PG Intracciabile"
quickLinks:
...
Le Categorie sono **Acumen, Animus, Ars, Numen, Sensus e Voluntas**.

| Categoria | Parametro Magico affine |
| --- | --- |
| **Acumen** | Acume |
| **Animus** | Empatia |
| **Ars** | Tecnica |
...
Sono definiti **Intracciabili** tutti i maghi e tutte le streghe che si sono rifiutati di eseguire il test W.O.M.B.A.T. e per questo sono esclusi ed emarginati dal resto della società magica.

Sono per lo più Ghermidori, Streghe e Maghi Oscuri conclamati, reietti. Tuttavia, di questa categoria fa parte anche una piccola percentuale di maghi e streghe perfettamente integrata all'interno della società magica, che ha deciso di opporsi all'esecuzione del Test per principio. Per questo, pur non essendo esclusi dalla società, essi vengono malvisti dalla maggior parte dei maghi e delle streghe.

**Sapienze affini:** una qualunque Sapienza.

## Che relazione c'è fra la Categoria Magica di un PG e il suo Mestiere?

Ogni Categoria Magica ha una Sapienza di riferimento necessaria a definire l'appartenenza del PG a tale Categoria. Tuttavia non è detto che l'attitudine magica di un PG, e quindi la sua Categoria, coincida necessariamente con il Mestiere che svolge. I PG possono scegliere di appartenere ad una Categoria Magica diversa dal Mestiere svolto ONGame.

> **Esempio:** un Auror può sviluppare Magia Difensiva e Offensiva ma essere comunque più avvezzo all'arte della Divinazione, tanto da scegliere di appartenere alla Categoria Magica dei Sensus; allo stesso modo uno Spezzaincantesimi può appartenere alla Categoria Magica dei Numen se ritiene di essere intimamente più incline a quel tipo di magia.

PG **Diplomatici, Giornalisti, Locandieri/Camerieri, Negozianti** o che svolgono **Mestieri Liberi** non hanno bisogno di sviluppare uno specifico Parametro Magico per lo svolgimento del proprio mestiere. Possono comunque scegliere una Categoria Magica di appartenenza ed avere gratuitamente i Livelli I delle Conoscenze Avanzate di una Sapienza, poiché la Categoria Magica è connessa all'essere personale del PG e non al suo Mestiere.
