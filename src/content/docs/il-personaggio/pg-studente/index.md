---
felixId: "72a6d6de-6662-462a-a309-effe80e42576"
title: "PG Studente"
description: "Regole e possibilità di gioco dedicate ai PG Studenti di Hogwarts."
contentType: landing
searchAliases: [studente, studente hogwarts, personaggio studente, pg studente]
applicability: [student]
quickFacts:
  - label: "Ingresso a Hogwarts"
    value: "11 anni"
  - label: "Anno scolastico"
    value: "1 settembre → 30 giugno"
  - label: "Materie seguite"
    value: "8 obbligatorie + 2 facoltative"
  - label: "Uso della magia"
    value: "Limitato fuori dai luoghi magici fino ai 17 anni"
quickLinks:
  - label: "Creare un PG Studente"
    href: "/il-personaggio/pg-studente/creare-un-pg-studente/"
    description: "Scheda PG, Parametri, crescita e cariche scolastiche."
  - label: "Studiare ad Hogwarts"
    href: "/il-personaggio/pg-studente/studiare-ad-hogwarts/"
    description: "Piano di Studi, Conoscenze, passaggi di anno e Borse di Studio."
  - label: "Coppa delle Case"
    href: "/il-personaggio/pg-studente/coppa-delle-case/"
    description: "Punti Casa, competizione scolastica e premi."
  - label: "Modalità di gioco"
    href: "/il-personaggio/pg-studente/modalita-di-gioco/"
    description: "Vivere ad Hogwarts, Trama, attività, fazioni e Missioni."
  - label: "Quidditch ad Hogwarts"
    href: "/mondo-magico/quidditch/quidditch-ad-hogwarts/"
    description: "Regole e campionato scolastico di Quidditch."
migration:
  status: revised
  sources:
    - document: "6. Giocare un PG Studente"
      section: "1. Il gioco dei PG Studenti"
      note: "Migrazione integrale della prima sezione della fonte."
---
...
Le materie obbligatorie vengono studiate sin dal I anno e sono: **Astronomia, Difesa Contro le Arti Oscure, Erbologia, Incantesimi, Pozioni, Storia della Magia e Trasfigurazione, più Babbanologia**, diventata obbligatoria a partire dall'entrata in vigore dello Statuto di Non-Troppa-Segretezza.

Le materie facoltative vengono invece introdotte al III anno e sono: **Aritmanzia, Antiche Rune, Cura delle Creature Magiche e Divinazione**. Di queste, ogni studente di Hogwarts sceglie di includerne nel proprio [Piano di Studi](./studiare-ad-hogwarts/) altre **2**, oltre alle 8 discipline obbligatorie, per un totale di **10 materie seguite**.
...
### Urgente Protocollo Scolastico

Dopo gli eventi del **7 luglio 2022** il Ministro della Magia Granger e i suoi collaboratori, insieme all'allora Preside di Hogwarts Minerva McGranitt, hanno stilato l'**Urgente Protocollo Scolastico** in linea con il neo Statuto di Non-Troppa-Segretezza.
...
1. **La Scuola:** attraverso i [Piani di Studio](./studiare-ad-hogwarts/), si possono apprendere Conoscenze nelle diverse materie e si può lavorare per migliorarle interagendo con i compagni o con PG più esperti, secondo quanto richiesto dal regolamento dei Piani di Studio. Tutti i Personaggi Studenti partecipano da background alle lezioni che si tengono a scuola, anche se soltanto di rado vengono ruolate ed aperte dal Narratore come Eventi giocabili.
2. **Il Castello:** attraverso il [FantaHogwarts](./modalita-di-gioco/), una collezione di spunti di gioco suddivisi per Allineamento, i PG Studenti possono esplorare il castello, interagire con Professori, Fantasmi, Quadri Magici e Personale Scolastico alla ricerca di Conoscenze esclusive o vietate e alla scoperta dei segreti della Scuola di Magia.
3. **L'Avventura:** periodicamente vengono proposte avventure a base di magia, esplosioni, disastri, [Quidditch](../../mondo-magico/quidditch/) e tutto ciò che Hogwarts e i suoi segreti ancora occulti hanno da offrire; ogni anno, inoltre, una speciale Trama coinvolge tutta la scuola e potrebbe sconvolgere qualche equilibrio.
4. **Il Tempo Libero:** nel tempo libero, si può ruolare ovunque sia concesso a uno Studente e costruire la propria storia intrecciandola con quella di altri personaggi negli ambienti del castello, nei dintorni o nella vicina Hogsmeade o alla Contea degli Elfi Liberi e nella Terra dei Lepricani.
