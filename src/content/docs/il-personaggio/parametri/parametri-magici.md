...
description: "Acume, Empatia, Percezione, Potenza, Tecnica, Volontà e regole complete di crescita."
contentType: rule
searchAliases:
  - "parametri magici"
applicability:
...
I Parametri Magici possono essere **persi**sia **temporaneamente che permanentemente**. Ad esempio, alcune azioni di gioco come subire gli effetti di una Fattura, fornisce dei malus temporanei per cui i Parametri Magici possono essere ridotti per un periodo di tempo limitato nel gioco, ma altre situazioni di gioco, come per esempio l'uccisione volontaria di una Creatura Magica, possono comportare malus che riducono in modo definitivo i Parametri.
