---
felixId: "53444e87-8230-48e7-8d29-40ca05feee03"
title: "Parametri Magici"
description: "Acume, Empatia, Percezione, Potenza, Tecnica e Volontà."
contentType: rule
searchAliases: [acume, empatia, percezione, potenza, tecnica, volontà, categorie magiche]
...
**Sapienze connesse:** Arcaica, Trasfigurativa
**Mestieri di riferimento:** Spezzaincantesimi

## Empatia

L'**Empatia** descrive la capacità del PG di saper relazionarsi agli esseri viventi del Mondo Magico, ossia Creature e Piante Magiche, oltre che alle altre persone. Indica dunque la capacità del PG di comprendere le necessità degli esseri viventi che ha di fronte, di saper interagire con loro e provvedere a ciò di cui più hanno bisogno.
**Sapienze connesse:** Magizoologica, Erbologica
...
**Mestieri di riferimento:** Divinatore
...
**Sapienze connesse:** Difensiva, Offensiva
**Mestieri di riferimento:** Auror
...
**Sapienze connesse:** Pozionistica, Medimagics
...
I Parametri Magici possono essere
**guadagnati**
in due modi:
**1) Permanentemente: **Il valore massimo di un Parametro Magico può essere aumentato oltre la soglia consentita, acquistandoligrazie ai Punti Post. Questo incremento è permanente e rappresenta un miglioramento duraturo nelle capacità magiche del PG;
**2) Temporaneamente:** Durante una role, è possibile aumentare la soglia massima o il valore raggiunto nel corso della giocata, tramite l'uso di Pozioni, Incantesimi, e altre Conoscenze Magiche che forniscono dei bonus temporanei. Questi bonus non modificano il valore base del Parametro, ma ne aumentano l'efficacia o il limite per la durata dell'effetto.
I Parametri Magici possono essere
**persi**
sia **temporaneamente che permanentemente**. Ad esempio, alcune azioni di gioco come subire gli effetti di una Fattura, fornisce dei malus temporanei per cui i Parametri Magici possono essere ridotti per un periodo di tempo limitato nel gioco, ma altre situazioni di gioco, come per esempio l'uccisione volontaria di una Creatura Magica, possono comportare malus che riducono in modo definitivo i Parametri.
Il
**recupero**
dei Parametri Magici persi dipende dalle circostanze specifiche di gioco. In genere, il recupero avviene con il **passare del tempo** o tramite l'**uso** di Pozioni, Conoscenze Magiche, o altre risorse come Ingredienti e Oggetti. Ogni situazione di gioco in cui un Parametro viene ridotto o perso potrebbe avere regole particolari per il recupero, che dovranno essere seguite o determinate dal Narratore o, dove questo non è presente, dalle regole esplicitate ad ogni caso specifico.
...
Sono importanti per la distribuzione iniziale dei Parametri Magici: ogni Categoria Magica ha un Parametro Magico peculiare che, nella distribuzione, deve essere al massimo possibile.
**Acumen:** Acume
**Animus:** Empatia
**Ars:** Tecnica
**Numen:** Potenza
