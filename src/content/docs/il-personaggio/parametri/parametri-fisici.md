...
description: "Destrezza, Fatica, Resistenza e Salute."
contentType: rule
searchAliases: [destrezza, fatica, resistenza, salute, punti salute, recuperare fatica]
...
• Resta fermo che la Fatica ridotta per effetto della **Salute** non segue il recupero autoconclusivo e si riallinea solo tramite le regole di Guarigione previste.
